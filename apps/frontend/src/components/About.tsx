...
export function About() {
  ...
  return (
    <section id="about" className="py-32 px-6 bg-gradient-to-b from-black to-zinc-900 relative overflow-hidden">
      <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-brand/5 blur-[100px]" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative aspect-[3/4] overflow-hidden">
              <img
                src="https://res.cloudinary.com/dwzatjoyv/image/upload/v1780411529/IMG_9485_mwinez.jpg"
                alt="Trainer"
